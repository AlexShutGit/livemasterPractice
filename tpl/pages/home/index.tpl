...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../static/css/direction-block-style.css" />
    ...
    <body>
        <div class="header">
            <div class="header__bar" id="header">
                <img
                    class="header__bar-img-mobile-white"
                    src="../img/header/logo.svg"
                    alt="Логотип"
                />
                <img
                    class="header__bar-img-mobile-black"
                    src="../img/header/logo_mobile_black.svg"
                    alt="Логотип"
                />
                <img
                    class="header__bar-img-desc-white"
                    src="../img/header/logo_desc.svg"
                    alt="Логотип"
                />
                <img
                    class="header__bar-img-desc-black"
                    src="../img/header/logo_desc_black.svg"
                    alt="Логотип"
                />
                <div class="header__bar-menu">
                    <a class="header__bar-menu-link" href="/">Контакты</a>
                    <a class="header__bar-menu-link" href="/">О Livemaster</a>
                    <a class="header__bar-menu-btn" href="/"
            ...
            <div class="header__text">
                <div>
                    <p class="header__text-main">
                        Livemaster<br />Практикум Start
                    </p>
                    <p class="header__text-disc">
                        Станьте востребованным<br />специалистом в IT
                    </p>
                </div>

                <img
                    class="header__img"
                    src="../img/header/bust.svg"
                    alt="Каменный бюст"
                />
>>>>>>> develop:pages/direction-block.html
            </div>
        </div>
            ...
            <div class="cards">
                <div class="card">
                    ...
                    <div class="card__content">
                        ...
                        <img class="card__content__image-mobile" src="../img/direction-block/develop mobile.png" alt="" />
                        <img class="card__content__image-desktop" src="../img/direction-block/develop desktop.png" alt="" />
=======
                    <div class="card">
...
<<<<<<< HEAD:tpl/pages/home/index.tpl
                <div class="card">
                    ...
                    <div class="card__content">
                        ...
                        <p class="card__content-paragraph">Вы научитесь управлять ресурсами, распределять задачи, решать проблемы и управлять рисками.</p>
                        <img class="card__content__image-mobile" src="../img/direction-block/manage mobile.png" alt="" />
                        <img class="card__content__image-desktop" src="../../img/direction-block/manage desktop.png" alt="" />
=======
        <div class="statistic">
    ...
    <div class="main">
        <div class="statistic">
            <div class="containerInfo">
                <div class="containerInfo__infoUSer">
                    <div class="text__numberWithAge">
                        <span class="text__numbers">17</span> <span class="text__age">лет</span>
                    </div>
                    <p id="text__info" class="text__info">развиваемся и растём</p>
                </div>
                <div class="containerInfo__infoUSer">
                    <span class="text__numbers">8 500 000</span>
                    <p class="text__info">клиентов в месяц</p>
...
>>>>>>> develop:pages/direction-block.html
        ...
        <div class="reviews">
            ...
            <div class="reviews__slider-box">
                <img
                    class="reviews__slider-box-arrow"
                    id="prev-slide"
                    data-next="prev"
                    src="../img/slider/left_arrow_slider.svg"
                    alt=""
                />
                ...
                <div class="reviews__slider" id="0">
                    <div class="reviews__slider-bar">
                        <img
                            class="reviews__slider-bar-head-img-big"
                            src="../img/slider/julia_hq.svg"
                            alt=""
                        />
                        ...
                        <div class="reviews__slider-bar-box">
                            <div class="reviews__slider-bar-head">
                                <img
                                    class="reviews__slider-bar-head-img"
                                    src="../img/slider/julia.png"
                                    alt=""
                                />

                                <div class="reviews__slider-bar-head-text">
                                    <p
                                        class="reviews__slider-bar-head-text-name"
                                    >
                                        Юлия
                                    </p>
                                    <span
                                        class="reviews__slider-bar-head-text-discription"
                                        >Курс "Разработчики", 2019 год</span
                                    >
                                </div>
                            </div>
                            ...
                            <div class="reviews__slider-bar-main">
                                <div class="reviews__slider-bar-main-text">
                                    Практикум открыл для меня невероятно
                                    интересный мир web-разработки, позволил
                                    на 3 недели погрузиться в жизнь настоящей
                                    IT-компании. Практикум — это непростой путь,
                                    но прошедшего его всё самое интересное ждёт
                                    впереди:)
                                </div>
                                <div class="reviews__slider-bar-main-text">
                                    Я до сих пор с теплотой вспоминаю это время
                                    и благодарю всех причастных
                                    за предоставленную мне возможность
                                    по завершении Практикума стать частью крутой
                                    команды.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="reviews__slider-bar-box">
                            <div class="reviews__slider-bar-head">
                                ...
                                <div class="reviews__slider-bar-head-text">
                                    ...
                                    <span
                                        class="reviews__slider-bar-head-text-discription"
                                        >Курс "Разработчики", 2022 год</span
                                    >
                                </div>
                            </div>
                            ...
                            <div class="reviews__slider-bar-main">
                                <div class="reviews__slider-bar-main-text">
                                    Практикум стал хорошим местом,
                                    чтобы закрепить знания, которые у меня были
                                    до этого и узнать что‑то новое. Интересные
                                    лекции и отзывчивые кураторы подогревали
                                    интерес к новым знаниям и преподносили
                                    материал очень понятно и развёрнуто.
                                </div>
                                <div class="reviews__slider-bar-main-text">
                                    Считаю, что практикум является хорошим
                                    стартом в компании и открывает путь к новым
                                    интересным испытания.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="reviews__slider slider-hide" id="2">
                    <div class="reviews__slider-bar">
                        ...
                        <div class="reviews__slider-bar-box">
                            ...
                            <div class="reviews__slider-bar-main">
                                <div class="reviews__slider-bar-main-text">
                                    Понравилась атмосфера внутри Практикума и
                                    командная работа при выполнении дипломного
                                    проекта. На протяжении всего практикума была
                                    поддержка среди преподавателей, они
                                    старались максимально объяснить для нас
                                    каждую тему и поддержка среди ребят.
                                </div>
                                <div class="reviews__slider-bar-main-text">
                                    Рад, что распределили по наставникам,
                                    которые помогали нам сделать первые шаги в
                                    проекте и были на протяжении всего этого
                                    времени.
                                </div>
                            </div>
                        </div>
                ...
                <div class="reviews__slider slider-hide" id="3">
                    <div class="reviews__slider-bar">
                        <img
                            class="reviews__slider-bar-head-img-big"
                            src="../img/slider/elizaveta_hq.svg"
                            alt=""
                        />
                        ...
                        <div class="reviews__slider-bar-box">
                            ...
                            <div class="reviews__slider-bar-main">
                                <div class="reviews__slider-bar-main-text">
                                    Участие в Практикуме выглядело для меня
                                    возможностью попробовать ту профессию, о
                                    которой на тот момент я могла только
                                    мечтать.
                                </div>
                                <div class="reviews__slider-bar-main-text">
                                    Погружение было сразу и с головой: минимум
                                    теории, максимум самостоятельной работы и
                                    задачи, приближенные к реальным.
                                </div>
                                <div class="reviews__slider-bar-main-text">
                                    А после... уже 4 года года профессионального
                                    роста, новых свершений, удивительных историй
                                    и приключений вместе с командой Livemaster
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="reviews__slider slider-hide" id="4">
                    <div class="reviews__slider-bar">
                        ...
                        <div class="reviews__slider-bar-box">
                            ...
                            <div class="reviews__slider-bar-main">
                                <div class="reviews__slider-bar-main-text">
                                    Практикум от Ярмарки Мастеров помог мне с
                                    нуля подняться до уровня Junior всего
                                    за 3 недели. Хотя другие курсы заняли бы
                                    минимум 3 месяца, и платно.
                                </div>
                                <div class="reviews__slider-bar-main-text">
                                    Структурированная информация, практические
                                    задания на закрепление знаний и ответы
                                    на возникшие вопросы от опытных
                                    специалистов, которые работают в сфере
                                    уже много лет.
                                </div>
                                <div class="reviews__slider-bar-main-text">
                                    Нисколько не пожалела, что когда‑то решилась
                                    попробовать пройти обучение. Это безумно
                                    крутой опыт.
                                </div>
                            </div>
                        </div>
                ...
                <img
                    class="reviews__slider-box-arrow"
                    id="next-slide"
                    src="../img/slider/right_arrow_slider.svg"
                    alt=""
                />
            </div>
            ...
            <div class="reviews__slider-bar-checkboxes">
                <div
                    class="reviews__slider-bar-checkboxes-circle checked"
                    id="0"
                ></div>
