            ...
            <div class="cards">
                ...
                <div class="card">
                    ...
                    <div class="card__content">
                        ...
                        <img class="card__content__image-mobile" src="../img/direction-block/watch mobile.png" alt="" />
                        <img class="card__content__image-desktop" src="../img/direction-block/watch desktop.png" alt="" />
                    </div>
                </div>
